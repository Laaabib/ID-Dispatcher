...
interface AuthContextType {
  user: User | null;
  role: 'admin' | 'user' | 'admin_approver' | 'it_approver' | 'inventory_manager' | 'hr_manager' | null;
  loading: boolean;
  login: () => Promise<void>;
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const [role, setRole] = useState<'admin' | 'user' | 'admin_approver' | 'it_approver' | 'inventory_manager' | 'hr_manager' | null>(null);
